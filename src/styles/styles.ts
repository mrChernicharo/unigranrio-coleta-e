export const styles = {
	...
	input2: 'mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md',
	submitBtn: `group relative w-full flex justify-center py-2 px-4 
		border border-transparent 
		text-sm font-medium rounded-md text-white 
		bg-indigo-600 
		hover:bg-indigo-700 
		focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`,
	btn: `inline-flex justify-center h-[40px] py-2 px-4 
		border-[2px] font-bold
		shadow-sm text-sm font-medium rounded-md 
		bg-white text-gray-500 border-gray-400
		hover:bg-gray-100 hover:text-gray-400 hover:border-gray-400 
		focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 
		disabled:bg-gray-300 disabled:text-gray-300 disabled:border-gray-300`,
	btnPrimary: `inline-flex justify-center py-2 px-4 
	...
	loginProviderBtn:
		'flex justify-center items-center w-full px-3 py-2 rounded-t-md rounded-b-md border border-gray-300 hover:bg-indigo-600',
